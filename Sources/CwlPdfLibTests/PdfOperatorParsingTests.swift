...
struct PdfOperatorParsingTests {
	@Test(arguments: [
		("blank-page.pdf", [PdfOperator.q, PdfOperator.Q]),
		("text-shapes-shading.pdf", [
			...
			CwlPdfParser.PdfOperator.c(-5.8333330000000005, 27.5, 27.5, -5.8333330000000005, 0.8333332999999999, 100.8333),
			...
			CwlPdfParser.PdfOperator.c(65.82912, 104.8816, 34.17088, 104.8816, 85.35533999999998, 14.644659999999998),
			CwlPdfParser.PdfOperator.c(-4.8815539999999995, 65.82912, -4.8815539999999995, 34.17088, 14.644659999999998, 14.644659999999998),
			CwlPdfParser.PdfOperator.c(34.17088, -4.8815539999999995, 65.82912, -4.8815539999999995, 14.644659999999998, 85.35533999999998),
			CwlPdfParser.PdfOperator.h,
			CwlPdfParser.PdfOperator.m(85.35533999999998, 14.644659999999998),
			CwlPdfParser.PdfOperator.S,
			CwlPdfParser.PdfOperator.Q,
			...
			CwlPdfParser.PdfOperator.c(993.7988000000001, 590.0, 997.8360999999999, 590.0, 588.8763, 1000.528),
			CwlPdfParser.PdfOperator.c(1004.408, 587.4640999999999, 1007.4639999999999, 584.4075999999999, 580.5275999999999, 1008.876),
			CwlPdfParser.PdfOperator.c(1010.0, 577.8360999999999, 1010.0, 573.7988000000001, 567.07, 1010.0),
			CwlPdfParser.PdfOperator.l(1010.0, 512.93),
			CwlPdfParser.PdfOperator.c(1010.0, 506.2012, 1010.0, 502.1639, 499.4724, 1008.876),
			CwlPdfParser.PdfOperator.c(1007.4639999999999, 495.5924, 1004.408, 492.53589999999997, 491.1237, 1000.528),
			CwlPdfParser.PdfOperator.c(997.8360999999999, 490.0, 993.7988000000001, 490.0, 490.0, 987.07),
			CwlPdfParser.PdfOperator.l(932.93, 490.0),
			CwlPdfParser.PdfOperator.c(926.2012, 490.0, 922.1639, 490.0, 491.1237, 919.4724),
			CwlPdfParser.PdfOperator.c(915.5924, 492.53589999999997, 912.5359, 495.5924, 499.4724, 911.1237000000001),
			CwlPdfParser.PdfOperator.c(910.0, 502.1639, 910.0, 506.2012, 512.93, 910.0),
			CwlPdfParser.PdfOperator.l(910.0, 567.07),
			CwlPdfParser.PdfOperator.c(910.0, 573.7988000000001, 910.0, 577.8360999999999, 580.5275999999999, 911.1237000000001),
			CwlPdfParser.PdfOperator.c(912.5359, 584.4075999999999, 915.5924, 587.4640999999999, 588.8763, 919.4724),
			CwlPdfParser.PdfOperator.c(922.1639, 590.0, 926.2012, 590.0, 590.0, 932.93),
			CwlPdfParser.PdfOperator.h,
			CwlPdfParser.PdfOperator.m(932.93, 590.0),
			CwlPdfParser.PdfOperator.W,
			CwlPdfParser.PdfOperator.n,
	...
	func `GIVEN a blank page WHEN content stream THEN q Q extracted`(filename: String, operators: [PdfOperator]) throws {
